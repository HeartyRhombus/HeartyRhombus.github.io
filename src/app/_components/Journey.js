  ...
  return (
    <div style={{ paddingLeft: '50px', paddingRight: '50px' }}>
      ...
      <p style={{ marginTop: '25px' }}>
        <i>
          "Tell me about yourself / How did you get into Software Engineering?"
        </i>
      </p>
      <p>
        I'm so glad you asked. Quite honestly, I fell into software engineering
        by complete accident.
      </p>
      <p style={{ textAlign: 'justify' }}>
        I, like many others, lost my job due to COVID-19; I was working for a
        cruise line at the time. I took some time to try and figure out what to
        do next, after realizing that I probably wouldn't be able to go back to
        the travel industry for an extended period of time, and ended up taking
        career quizzes.
        <br />
        <br />I know, I did the thing that everyone tells you not to do...
        <br />
        <br />
        ...
        <br />
        <br />I would be lying if I didn't say the job search afterwards wasn't
        hard, and at times it definitely had me second guessing my decision. But
        I was able to find an early career role, with a year long starting
